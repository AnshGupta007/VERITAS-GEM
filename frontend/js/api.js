...
export const api = {
  ...
  queryCopilot: (query, apiKey = null, model = null, history = []) =>
    request('/copilot/query', {
      method: 'POST',
      body: JSON.stringify({ query, api_key: apiKey, model, history }),
    }),
  askCopilot: (query, apiKey = null, model = null, history = []) =>
    request('/copilot/query', {
      method: 'POST',
      body: JSON.stringify({ query, api_key: apiKey, model, history }),
    }),
